define({ 
  ...
  loadFormLatestMovies : function()
  {
    ...
    {
      kony.print("loadFormLatestMovies exception"+err);
    }
  },
  ...
  getSelectedGridData: function()
  {
    ...
    try
    {
      ...
      let movieID = dataFive.col3id.toString();
      kony.print("movieID"+movieID);
      if(movieID !== null || movieID !== undefined)
      {
        ...
        var headers = {};
        kony.print("invoke service getDetailsAndCredits"+JSON.stringify(inputParams));
    ...
    {
      kony.print("getSelectedGridData exception"+err);
    }
  ...
  getDetailsAndCreditsSuccessCallback : function(response)
  {
    try
    {
      kony.print("getDetailsAndCreditsSuccessCallback"+JSON.stringify(response));
      let movieDetails = response;
      this.view.ImageView.src = CONSTANTS.image_link_500+movieDetails.poster_path;
      this.view.RTtitle.text = movieDetails.original_title + "\n" + movieDetails.tagline;
      this.view.lblRating.text = "Rating :"+movieDetails.vote_average;
      this.view.lblOverview.text = movieDetails.overview;
      this.view.Imageone.src = CONSTANTS.image_link_profile+movieDetails.profile_path;
      this.view.Imagetwo.src = CONSTANTS.image_link_profile+movieDetails.profile_path;
      this.view.Imagethree.src = CONSTANTS.image_link_profile+movieDetails.profile_path;
      
      this.view.FlexMoviePopup.isVisible = true;
    }
    catch(err)
    {
  ...
  getDetailsAndCreditsFailureCallback : function(error)
  {
    try
    {
      kony.print("getDetailsAndCreditsFailureCallback"+JSON.stringify(error));
    }
    catch(err)
    {
